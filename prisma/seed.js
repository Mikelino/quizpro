      ...
      questions: {
        create: [
          ...
          },
          {
            ...
            correctIndex: 1,
            hostNotes: { title: "Don't Stop Me Now", artist: "Queen", year: 1978, cueSuggestion: "1:05" },
            timeLimit: 20,
            scoringMode: "speed",
          },
          {
            position: 3,
            type: "image",
            prompt: "Quel collaborateur se cache derrière cet avatar flouté ?",
            options: ["Julien (CTO)", "Marie (CPO)", "David (CEO)", "Sophie (CFO)"],
            correctIndex: 2,
            hostNotes: { imageUrl: "https://example.com/blurred-david.jpg" },
            timeLimit: 15,
            scoringMode: "double",
          },
        ],
